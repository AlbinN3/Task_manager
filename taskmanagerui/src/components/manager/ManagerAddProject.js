...
class ManagerAddProjects extends Component {
  constructor(props) {
    super(props);
    this.state = {
      project: {
  ...
  handleManagerChange(){
   this.setState(Object.assign(this.state.project, { managerid: sessionStorage.getItem("userId")}));
}
        ...
        <div className="card-body">
          ...
          <form className="row g-3 needs-validation" noValidate>
            ...
            <div className="col-12">
              ...
              <div className="input-group has-validation">
                <input type="text" name="username" value={this.state.userid}  className="form-control" id="yourUsername" disabled required />
                <div className="invalid-feedback">Please enter project name.</div>
              </div>
            </div>
            <div className="col-12">
...
export default ManagerAddProjects;