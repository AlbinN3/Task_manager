...
class ManagerUsersList extends Component {
  ...
  handleEditChange(e, userid) {
    ...
    window.location.href = "/manager-edit-users";
  }
handleAddUserBtnChange(e){
    
  localStorage.setItem("userId", "")
    window.location.href = "/manager-add-users";
  }
  handleViewChange(e, userid) {
    localStorage.setItem("userId", userid)
    window.location.href = "/manager-view-user";
  }
  handleDeleteChange(e, userid) {
   ...
   handleSearchOnChange(e){
     if(e.target.value) {
       fetch('http://localhost:8080/users/under/manager/search?name='+e.target.value,{
         method: 'GET',
         headers: {
  ...
  async handleOnLoad(){
    await fetch('http://localhost:8080/users/under/manager',{
      method: 'GET',
      headers: {
        "Accept" : "application/json",
        "Content-Type" : "application/json"
