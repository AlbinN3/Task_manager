...
class ManagerEditProject extends Component {
  constructor(props) {
    super(props);
    this.state = {
      project: {
...
handleManagerChange(e){
  ...
  handleSubmit() {
    fetch('http://localhost:8080/project/add', {
      ...
      .then((data) => {
        this.setState({ project: data });
        window.location.href = "/manager-project-list"
      })
  }
  render() {
    return (
      <div className="card mb-3">
        <div className="card-body">
          <div className="pt-4 pb-2">
            ...
            <p className="text-center small">Edit project details</p>
          </div>
          <form className="row g-3 needs-validation" noValidate>
            ...
            <div className="col-12">
              <label htmlFor="yourUsername" className="form-label">Manager Id</label>
              <div className="input-group has-validation">
                <input type="text" name="username" value={this.state.project.managerid} onChange={(event) => { this.handleManagerChange(event) }} className="form-control" id="yourUsername" disabled required />
                <div className="invalid-feedback">Please enter project name.</div>
              </div>
            </div>
            <div className="col-12">
            ...
            id="dropdown" 
            name="dropdown" 
            value={this.state.project.teamleaderid} 
