...
class ManagerViewUsers extends Component {
  constructor(props) {
    super(props);
    this.state = {
      users: {
        ...
        <div className="card-body">
          ...
          <form className="row g-3 needs-validation" noValidate>
            ...
            <div className="col-12">
              ...
              <input type="password" name="password" className="form-control" id="password" value={this.state.users.password} disabled required />
            ...
            <div className="col-12">
              <label htmlFor="yourPassword" className="form-label">Designation</label>
              <input type="text" name="duedate" className="form-control" id="duedate" value={this.state.users.email} disabled required />
              <div className="invalid-feedback">Please enter project end date!</div>
            </div>
            <div className="col-12">
              <br />
