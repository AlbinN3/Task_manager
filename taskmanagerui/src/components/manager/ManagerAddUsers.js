...
class ManagerAddUsers extends Component {
  constructor(props) {
    super(props);
    this.state = {
      users: {
      ...
      <div className="card mb-3">
        <div className="card-body">
          <div className="pt-4 pb-2">
            <h5 className="card-title text-center pb-0 fs-4">Add User Details</h5>
            <p className="text-center small">Enter user details</p>
          </div>
          <form className="row g-3 needs-validation" noValidate>
            ...
            <div className="col-12">
              ...
              <input type="password" name="password" className="form-control" id="password" value={this.state.users.password} onChange={(evt)=>this.handlePasswordChange(evt)} required />
...
export default ManagerAddUsers;