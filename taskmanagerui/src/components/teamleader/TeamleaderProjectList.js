...
class TeamleaderProjectsList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchValue: "",
    ...
    this.handleMainTaskCreate=this.handleMainTaskCreate.bind(this);
  ...
  handleViewChange(e, projectid) {
    ...
    window.location.href = "/teamleader-view-project";
  }

 //MAIN TASK CREATION
handleMainTaskCreate(e,projectid){
    localStorage.setItem("projectId", projectid)
    window.location.href = "/teamleader-create-maintask";
}
                      ...
                      return (
                        <tr className="odd" key={index}>
                          ...
                          <td>
                            ...
                            <a href="#" onClick={evt => this.handleMainTaskCreate(evt, project.projectid)} className="grn_table_link">Create Main Task  </a>
                          </td>
                        </tr>);
...
export default TeamleaderProjectsList;