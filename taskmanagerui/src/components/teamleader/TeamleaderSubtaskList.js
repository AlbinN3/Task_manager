...
class TeamleaderTasksList extends Component {
  constructor(props) {
    ...
    this.handleAddSubTaskBtnChange = this.handleAddSubTaskBtnChange.bind(this);
    this.state.taskData.maintaskid=localStorage.getItem('mainTaskId');
  ...
  handleAddSubTaskBtnChange(e){
    window.location.href = "/teamleader-add-subtask";
  }

  handleViewChange(e, taskid) {
    localStorage.setItem("taskId", taskid)
    window.location.href = "/teamleader-view-subtask";
  }

  handleEditChange(e, taskid) {
    localStorage.setItem("taskId", taskid)
    window.location.href = "/teamleader-edit-subtask";
  }
  ...
  async handleOnLoad() {
    await fetch('http://localhost:8080/task/teamleader/subtask/all?userId='+sessionStorage.getItem("userId")+'&mainTaskId='+localStorage.getItem("mainTaskId"), {
      method: 'GET',
      headers: {
        "Accept": "application/json",
        "Content-Type": "application/json"
  ...
  handleIssueChange(e,taskid) {
    localStorage.setItem("taskId", taskid)
    window.location.href = "/teamleader-view-issues";
  }
  render() {
    return (
      <div className="container-fluid">
        ...
        {/* Page Heading */}
        <h1 className="h3 mb-2 text-gray-800">Sub Tasks List</h1>
            ...
            <div className="table-responsive">
              <div id="dataTable_wrapper" className="dataTables_wrapper dt-bootstrap4">
                <div className="row">
                  ...
                  <label></label>
                  <button className="btn btn-primary w-100" type="button" style={{padding: "13px"}} onClick={(evt)=>this.handleAddSubTaskBtnChange(evt)}>Add Sub Task</button>
                  </div>
                      ...
                      return (
                        <tr className="odd" key={index}>
                          ...
                          <td>
                            ...
                            <div><a href="#" onClick={evt => this.handleIssueChange(evt, task.taskid)} className="grn_table_link">View Issues</a></div>
                          </td>
                        </tr>);
