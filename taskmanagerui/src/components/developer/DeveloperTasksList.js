...
import '../../assets/css/warning-styles.css';
class DeveloperTasksList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchValue: "",
  ...
  handleViewChange(e, taskid) {
    ...
    window.location.href = "/developer-view-tasks";
  }

  handleAddProgress(e, taskid) {
    localStorage.setItem("taskId", taskid)
    window.location.href = "/developer-add-progress";
  }
                      ...
                      return (
                        <tr className="odd" key={index}>
                          ...
                          <td>
                            ...
                            <a href="#" onClick={evt => this.handleAddProgress(evt, task.taskid)} className="grn_table_link">Add Progress  </a>
                          </td>
                        </tr>);
